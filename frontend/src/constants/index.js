 ...
 export const workExperiences = [
  {
    ...
    title:
      'Contributed to a large-scale production EdTech platform serving tens of thousands of active users, with a strong focus on backend performance optimization, infrastructure efficiency, and video processing pipelines.',
    points: [
      ...
      'Refactored and optimized SQL queries using indexing, caching, and query restructuring, reducing overall CPU utilization by ~80–85%.',
      'Redesigned the video upload and transcoding pipeline using FFmpeg and optimized workflows, achieving over 80% faster video processing.',
      'Significantly reduced infrastructure resource usage by optimizing compute and GPU workloads while maintaining system reliability.',
      'Improved system stability by resolving critical production issues across multiple microservices, leading to a ~90% reduction in app crashes.',
      'Optimized inter-service communication by reducing unnecessary Pub/Sub calls and minimizing cross-service overhead.',
      'Worked on backend features involving large datasets and multi-database operations with a focus on scalability.',
      'Collaborated on frontend integrations using React.js to ensure seamless backend–frontend data flow.',
      'Contributed to performance improvements that supported consistent month-over-month user growth post-optimization.',
    ],
