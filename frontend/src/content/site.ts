export const site = {
  ...
  currentRoles:
    "Senior Full-Stack Developer at Newral — building scalable backend systems, infrastructure, and distributed services for production applications serving 100,000+ concurrent users.",
  openTo:
